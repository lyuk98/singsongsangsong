...
@Getter
public enum Genre {
	BLUES("Boogie Woogie", "Chicago Blues", "Country Blues", "Delta Blues", "Electric Blues", "Harmonica Blues", "Jump Blues", "Louisiana Blues", "Modern Electric Blues", "Piano Blues", "Rhythm & Blues",
	...
	FOLKWORLDANDCOUNTRY("African", "Bluegrass", "Cajun", "Canzone Napoletana", "Catalan Music", "Celtic", "Country", "Fado", "Flamenco", "Folk", "Gospel", "Highlife", "Hillbilly", "Hindustani", "Honky Tonk", "Indian Classical", "Laïkó", "Nordic", "Pacific", "Polka", "Raï", "Romani", "Soukous", "Séga", "Volksmusik", "Zouk",
		"Éntekhno Funk / Soul: Afrobeat", "Boogie", "Contemporary R&B", "Disco", "Free Funk", "Funk", "Gospel", "Neo Soul", "New Jack Swing", "P.Funk", "Psychedelic", "Rhythm & Blues", "Soul", "Swingbeat", "UK Street Soul"),
	HIPHOP("Bass Music", "Boom Bap", "Bounce", "Britcore", "Cloud Rap", "Conscious", "Crunk", "Cut-up/DJ", "DJ Battle Tool", "Electro", "G-Funk", "Gangsta", "Grime", "Hardcore Hip-Hop", "Horrorcore", "Instrumental", "Jazzy Hip-Hop", "Miami Bass", "Pop Rap", "Ragga HipHop", "RnB/Swing", "Screw", "Thug Rap", "Trap", "Trip Hop", "Turntablism"),
	...
	NONMUSIC("Audiobook", "Comedy", "Dialogue", "Education", "Field Recording", "Interview", "Monolog", "Poetry", "Political", "Promotional", "Radioplay", "Religious", "Spoken Word"),
	...
	RAGGAE("Calypso", "Dancehall", "Dub", "Lovers Rock", "Ragga", "Reggae", "Reggae-Pop", "Rocksteady", "Roots Reggae", "Ska", "Soca"),
